...
data_path = os.path.join(MULTILABEL_ROOT, 'outputs', 'llama3-8B')
results_dir = os.path.join(MULTILABEL_ROOT, 'results', 'llama3-8B')
results_file = os.path.join(results_dir, 'llama-3-multilabel-classification.csv')
best_results_file = os.path.join(results_dir, 'llama-3-multilabel-classification-best.csv')

tel_topic_match = [
    "teleology", "telecommunications", "radio frequency", "radar", "mobile phones",
    "bluetooth", "WiFi", "data networks", "optical networks", "microwave technology",
    "radio technology", "mobile radio", "4G", "LiFi", "mobile network",
    "radio and television", "satellite radio", "telecommunications networks", "5G",
    "fiber-optic network", "cognitive radio", "fixed wireless network"
]
